...
|             [barrages.json](https://github.com/MrLar/AzurLaneData/tree/main/data/barrages.json)             |              Contains info about all almost all barrages              | `object` |                              Skill ID -> [`Barrage[]`](./barrages/index.md#barrage)                              |        `Record<number, Barrage[]         | undefined>` |                                                                                         |
