...
|            [juu_posts.json](https://github.com/MrLar/AzurLaneData/tree/main/data/juu_posts.json)            |       Contains all Juustagram posts made by ships.       | `object` |                    "posts" -> Profile ID -> [`JuuProfile`](./juustagram/index.md#juu-profile)                    | `{ hidden: number[], posts: Record<number, JuuPost | undefined> }` |             |
